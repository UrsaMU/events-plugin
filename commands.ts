...
Switches (staff only):
  /create <title>=<date>/<desc>   Create a new event. Date: YYYY-MM-DD or YYYY-MM-DD HH:MM.
  /edit <#>/<field>=<value>       Edit a field: title, description, location, starttime, endtime, maxattendees, tags.
  /status <#>=<status>            Set status: upcoming, active, completed, cancelled.
